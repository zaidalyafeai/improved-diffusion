LOGDIR="calliargen/model_50k_onefont"  # fill in directory to save checkpoints/etc.
...
## learning rate, etc.
TRAIN_FLAGS+=" --lr 1e-4 --batch_size 4 --lr_warmup_steps 200"
...
os.system(f"TOKENIZERS_PARALLELISM=false OPENAI_LOGDIR={LOGDIR} python3 scripts/image_train.py --data_dir CalliarGen/data_50k_onefont/train {MODEL_FLAGS} {DIFFUSION_FLAGS} {TRAIN_FLAGS} {RESUME_FLAGS}")
