BATCH_SIZE = "128"
IMG_SIZE = "64"
LOGDIR = f"calliargen/model_10k_mulfont_bs_{BATCH_SIZE}_{IMG_SIZE}x{IMG_SIZE}_non_frozen/"  # fill in directory to save checkpoints/etc.
...
MODEL_FLAGS+=" --clipname ViT-L/14@336px --freeze_capt_encoder 0"
